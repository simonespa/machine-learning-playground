...
```sh
pip install flake8 black isort jupyterlab ipywidgets numpy scipy sympy pandas ydata-profiling statsmodels prophet scikit-learn tensorflow tensorflow_datasets torch torchvision torchaudio keras xgboost matplotlib seaborn
```
